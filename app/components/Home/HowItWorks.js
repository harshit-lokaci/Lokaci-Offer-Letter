            ...
            {steps.map((step, index) => (
              ...
              >
                ...
                <motion.div
                  ...
                  className="absolute -top-4 -right-4 w-12 h-12 bg-gradient-to-r from-blue-800 to-blue-900 text-white rounded-full flex items-center justify-center font-bold text-lg shadow-lg z-20"
                >
                  {step.step}
                </motion.div>
        ...
        >
          <div className="bg-gradient-to-r from-blue-50 via-indigo-50 to-purple-50 rounded-3xl p-8 border border-blue-100/50">
            ...
            {/* <motion.a
              ...
              whileTap={{ scale: 0.98 }}
              className="inline-flex items-center gap-3 bg-gradient-to-r from-blue-800 to-blue-900 text-white px-8 py-4 rounded-sm font-semibold shadow-lg hover:shadow-xl transition-shadow"
            >
              <span>Get Started</span>
              <FaArrowRight />
            </motion.a> */}
            <Button text={"Get Started"} link={"/generator"} />
          </div>
        </motion.div>
      </div>
    </section>

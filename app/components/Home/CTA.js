    ...
    <section className="relative py-24 bg-gray-50">
      <div className="relative max-w-5xl mx-auto text-center px-6">
        ...
        >
          ...
          {/* <Link
            href="/generator"
            className="inline-flex items-center gap-2 bg-gray-800 text-white px-8 py-4 rounded-sm text-lg font-medium shadow hover:bg-gray-900 transition-all duration-300"
          >
            Get Started Now →
          </Link> */}
          <Button text={"Get Started Now"} link={"/generator"}/>
        </motion.div>
      </div>
    </section>
  );

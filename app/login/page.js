    ...
    const handleLogin = async (e) => {
        ...
        try {
            ...
            if (res.ok) {
                ...
                toast.error(data.message || "Access denied", { position: "top-right", autoClose: 2000 });
            }
        } catch (err) {
                    ...
                    <div className="w-full max-w-md">
                        ...
                        <form onSubmit={handleLogin} className="space-y-5">
                            ...
                            <button
                                type="submit"
                                disabled={loading}
                                className={`w-full py-3 rounded-lg text-white font-semibold shadow-md transition ${loading

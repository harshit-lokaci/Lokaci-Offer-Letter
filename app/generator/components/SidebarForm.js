...
import { MdDelete, MdExpandMore, MdSchedule } from "react-icons/md";
...
const SidebarForm = () => {
  ...
  return (
    <div className="order-1 max-w-3xl h-full lg:max-h-[130vh] overflow-y-scroll scrollbar-none border-2 border-gray-200">
      <div className="w-full bg-white rounded-lg shadow-lg p-6">
        ...
        <div className="space-y-5 ">
          {/* Candidate Name */}
          <div>
            <label className="form-label flex justify-between items-center gap-2 text-sm font-medium text-gray-700 mb-1">
          ...
          <div>
            <label className="form-label justify-between flex items-center gap-2 text-sm font-medium text-gray-700 mb-1">
          ...
          {/* Work Location */}
          <div>
            <label className="form-label flex items-center justify-between gap-2 text-sm font-medium text-gray-700 mb-1">
          ...
          </div>
          {
            menuOpen ? (
              <><div>
                ...
                {/* Required Documents */}
                <div>
                  <label className="form-label flex items-center justify-between gap-2 text-sm font-medium text-gray-700 mb-2">
          ...
          <div className="flex flex-col gap-3 mt-6">
            <button
              onClick={generatePDF}
              className="relative inline-flex gap-2 items-center justify-center px-6 py-3 overflow-hidden font-medium transition-all bg-red-600 rounded-xl group"
            >
              <span className="absolute top-0 right-0 inline-block w-4 h-4 transition-all duration-500 ease-in-out bg-red-700 rounded group-hover:-mr-4 group-hover:-mt-4">
                <span className="absolute top-0 right-0 w-5 h-5 rotate-45 translate-x-1/2 -translate-y-1/2 bg-white"></span>
              </span>
              <span className="absolute bottom-0 left-0 w-full h-full transition-all duration-500 ease-in-out delay-200 -translate-x-full translate-y-full bg-red-800 rounded-2xl group-hover:mb-12 group-hover:translate-x-0"></span>
            ...
            <button
              ...
              className="px-6 py-3 bg-green-700 hover:bg-green-800 flex items-center justify-center gap-2 text-white rounded-xl transition-colors duration-200"
            >
